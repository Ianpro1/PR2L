...
def make_env(ENV_NAME, inconn=None):
        ...
        if inconn is not None:
            env = common_wrappers.LiveRenderWrapper(env, sendimg(inconn, frame_skip=12))
...
if __name__ == '__main__':
    ...
    time.sleep(1)
    net.apply(models.network_reset)
    net.load_state_dict(torch.load("model_saves/BreakoutNoFrameskip-v4/2023-02-25/modelsave4_(00-42).pt"))
    tgt_net.sync()
